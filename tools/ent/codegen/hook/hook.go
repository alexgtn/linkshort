...
type LinkFunc func(context.Context, *codegen.LinkMutation) (codegen.Value, error)

// Mutate calls f(ctx, m).
func (f LinkFunc) Mutate(ctx context.Context, m codegen.Mutation) (codegen.Value, error) {
	mv, ok := m.(*codegen.LinkMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *codegen.LinkMutation", m)
	}
	return f(ctx, mv)
}
