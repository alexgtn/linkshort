-- create "links" table
CREATE TABLE `links` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `short_path` text NOT NULL, `long_uri` text NOT NULL, `accessed_times` integer NOT NULL DEFAULT 0, `created_at` datetime NOT NULL);
